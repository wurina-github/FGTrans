...
p.add_argument('--config', type=str,default='./configs/train/bottle.yml', help='training configuration.')
...
p.add_argument('--batch_size', type=int, default=5, help='training batch size.')
p.add_argument('--lr', type=float, default=1e-4, help='learning rate. default=1e-4')
p.add_argument('--epochs', type=int, default=70, help='Number of epochs to train for.')
...
p.add_argument('--num_instances', type=int,default=45, help='numbers of instance in the training set.')
...
# define dataloader
# ###########change train_split to eval_split
