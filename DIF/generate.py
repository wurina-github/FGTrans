...
p.add_argument('--config', type=str,default='configs/generate/bottle.yml', help='training configuration.')
p.add_argument('--subject_idx',default=(0,), help='index of subject to generate')
...
for idx in opt.subject_idx:
    ...
    sdf_meshing.create_mesh(model, os.path.join(root_path,'test%04d'%idx), subject_idx=idx, N=128,level=opt.level, category=meta_params['experiment_name'])
